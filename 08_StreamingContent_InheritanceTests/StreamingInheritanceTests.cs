    ...
    public class StreamingInheritanceTests
    {
        ...
        public void PlayingWithInheritanceNotes()
        {
            ...
            foreach (StreamingContent content in listOfContent)
            {
                ...
                if (content is Movie movieExample)//can also use content.GetType() == type(Movie)
                {
                    Console.WriteLine(movieExample.OscarNominations);
                }
                if(content is Show showExample)
                {
                    Console.WriteLine(showExample.NumberOfSeasons);
                }
            }
        ...
        public void GetAllShows_ShouldReturnCorrectNumberOfShows()
        {
            ...
            //Assert
            Assert.AreEqual(3, actualReturn.Count);
        }
